...
Tags: antispam, captcha, spam, security
...
Math Captcha is an effective CAPTCHA for WordPress that integrates into login, registration, comments, Contact Form 7 and bbPress.

== Description ==

[Math Captcha](http://www.dfactory.eu/plugins/math-captcha/) is an effective and easy to use CAPTCHA for WordPress that seamlessly integrates into login, registration, lost password, comments, bbPress and Contact Form 7.
...
= 1.3.0 =
* New: Completely revemped captcha mechanism
* New: Option to reload captcha
* New: WordPress 6.5 compatibility
* New: PHP 7.x and PJP 8.x compatibility
* Fix: Potential security fixes
...
= 1.3.0 =
Completely revemped captcha mechanism, Option to reload captcha, WordPress 6.5 compatibility, Potential security fixes